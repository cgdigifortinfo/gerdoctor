...
## Completed (recent)
- [x] 2026-04-20: **Animierter Journey-Durchlauf** — Play-Button im Flowbuilder startet Step-by-Step-Walkthrough (1.5s/Step). Aktueller Step pulsiert in Amber, Overlay unten zeigt `Step X / Y` + kumulative ETA (Tage/Wochen/Monate). Respektiert aktives Simulator-Profil (hidden Steps werden übersprungen). Stop-Button beendet jederzeit. E2E Case 15 PASS (5/5 distinct snapshots).
