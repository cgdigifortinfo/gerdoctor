...
## Completed (recent)
- [x] 2026-04-21: **Header: Fortschritt-Prozentsatz neben Abschlussdatum** — UserDashboard-Header zeigt nun zwei Pills nebeneinander: links das ETA-Datum (teal solid), rechts die Completion-Progress-Bar + Prozent (teal subtle). Mobile-Layout analog unter dem Logo. Updates automatisch, wenn Milestones abgeschlossen werden.
