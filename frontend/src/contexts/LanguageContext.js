...
const translations = {
  en: {
    ...
    partner_filter: 'Filter', partner_filter_fachgebiet: 'Specialty', partner_filter_all: 'All', recommended_for_you: 'Recommended for you',
  ...
  de: {
    ...
    partner_filter: 'Filter', partner_filter_fachgebiet: 'Fachgebiet', partner_filter_all: 'Alle', recommended_for_you: 'Empfohlen für dich',
